                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-0" style="overflow-x:auto;">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($withdrawData as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('withdraw-details', $data->id) }}"><button
                            ...
                            <div class="float-start" style="margin-left:2%; margin-top:1%; margin-bottom:1%">
                                Showing <b>{{ $withdrawData->firstItem() }}</b> to <b>{{ $withdrawData->lastItem() }}</b> of
                                <b>{{ $withdrawData->total() }}</b>
                                records
                            </div>
                            <div class="float-end" style="margin-right:2%; margin-top:1%; margin-top:1%">
                                {{ $withdrawData->links('pagination::bootstrap-4') }}
                            </div>
                        </div>
                    </div>
                </div>
